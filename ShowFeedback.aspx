<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowFeedback.aspx.cs" Inherits="jjjjj.ShowFeedback" %>
...
<body>
  ...
  <form id="form1" runat="server">
    <div>
    <center>
    <asp:Label ID="Label2" runat="server" Text="User FeedBack"
    ...
    AutoGenerateColumns="false" Width="514px" Height="173px" BackColor="#CCFFFF" 
        ...
        <Columns>
          <asp:BoundField HeaderText="FeedBackID" DataField="ID" />
