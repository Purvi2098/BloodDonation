<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DonorDetail.aspx.cs" Inherits="jjjjj.DonorDetail" %>
...
<body>
 ...
 <header class="site-header">
   ...
   <center>
       <asp:Label ID="Label1" runat="server" Text="Registered Donor Detail"
    ...
    AutoGenerateColumns="false" Width="514px" Height="173px" BackColor="#CCFFFF" 
        ...
        <asp:BoundField HeaderText="ContactNo" DataField="ContactNO_office" />
